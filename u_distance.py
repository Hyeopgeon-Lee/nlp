...
#문서1과 문서3의 유사도 분석
print("문석1과 문서3의 유사도 : "+ str(dist(np.array(result[0]), np.array(result[2]))))

#문서1과 문서4의 유사도 분석
print("문석1과 문서4의 유사도 : "+ str(dist(np.array(result[0]), np.array(result[3]))))

#문서1과 문서5의 유사도 분석
print("문석1과 문서5의 유사도 : "+ str(dist(np.array(result[0]), np.array(result[4]))))

#문서1과 문서6의 유사도 분석
print("문석1과 문서6의 유사도 : "+ str(dist(np.array(result[0]), np.array(result[5]))))
...
for i in range(N): # 각 문서에 대해서 아래 명령을 수행
    ...
    if doc_number!=1:
        ...
        print("문석1과 문서"+ str(doc_number) +"의 유사도 : " + str(u_res))ㅇ
